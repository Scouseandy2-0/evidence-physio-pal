...
-- Update all functions to have properly set search_path
...
DROP FUNCTION IF EXISTS public.audit_security_event(text, uuid, jsonb);
...
DROP FUNCTION IF EXISTS public.get_security_headers();
